...
namespace Small.Net.Graphic.Core
{
    ...
    public struct Result : IEquatable<Result>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SharpDX.Result"/> to <see cref="int"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SharpDX.Result"/> to <see cref="uint"/>.
        /// </summary>
        /// <param name="result">The result.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="int"/> to <see cref="SharpDX.Result"/>.
        /// </summary>
        /// <param name="result">The result.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="uint"/> to <see cref="SharpDX.Result"/>.
        /// </summary>
        /// <param name="result">The result.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        public static Result GetResultFromWin32Error(int win32Error)
        {
            ...
            return win32Error <= 0
                ? win32Error
                : (int) (win32Error & 0x0000FFFF | FACILITY_WIN32 << 16 | 0x80000000);
        }
        ...
        public readonly static Result Ok = new Result(unchecked(0x00000000));

        /// <summary>
        /// Result code False
        /// </summary>
        /// <unmanaged>S_FALSE</unmanaged>
        public readonly static Result False = new Result(unchecked(0x00000001));
        ...
        public static readonly ResultDescriptor Abort =
            new ResultDescriptor(unchecked((int) 0x80004004), "General", "E_ABORT", "Operation aborted");
        ...
        public static readonly ResultDescriptor AccessDenied = new ResultDescriptor(unchecked((int) 0x80070005),
            "General", "E_ACCESSDENIED", "General access denied error");
        ...
        public static readonly ResultDescriptor Fail =
            new ResultDescriptor(unchecked((int) 0x80004005), "General", "E_FAIL", "Unspecified error");
        ...
        public static readonly ResultDescriptor Handle =
            new ResultDescriptor(unchecked((int) 0x80070006), "General", "E_HANDLE", "Invalid handle");
        ...
        public static readonly ResultDescriptor InvalidArg = new ResultDescriptor(unchecked((int) 0x80070057),
            "General", "E_INVALIDARG", "Invalid Arguments");
        ...
        public static readonly ResultDescriptor NoInterface = new ResultDescriptor(unchecked((int) 0x80004002),
            "General", "E_NOINTERFACE", "No such interface supported");
        ...
        public static readonly ResultDescriptor NotImplemented =
            new ResultDescriptor(unchecked((int) 0x80004001), "General", "E_NOTIMPL", "Not implemented");
        ...
        public static readonly ResultDescriptor OutOfMemory =
            new ResultDescriptor(unchecked((int) 0x8007000E), "General", "E_OUTOFMEMORY", "Out of memory");
        ...
        public static readonly ResultDescriptor InvalidPointer =
            new ResultDescriptor(unchecked((int) 0x80004003), "General", "E_POINTER", "Invalid pointer");
        ...
        public static readonly ResultDescriptor UnexpectedFailure = new ResultDescriptor(unchecked((int) 0x8000FFFF),
            "General", "E_UNEXPECTED", "Catastrophic failure");
        ...
        public static readonly ResultDescriptor WaitAbandoned = new ResultDescriptor(unchecked((int) 0x00000080L),
            "General", "WAIT_ABANDONED", "WaitAbandoned");
        ...
        public static readonly ResultDescriptor WaitTimeout =
            new ResultDescriptor(unchecked((int) 0x00000102L), "General", "WAIT_TIMEOUT", "WaitTimeout");
        ...
        public static readonly ResultDescriptor Pending =
            new ResultDescriptor(unchecked((int) 0x8000000AL), "General", "E_PENDING", "Pending");
    }
}
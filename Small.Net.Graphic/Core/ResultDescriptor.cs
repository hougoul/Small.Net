...
namespace Small.Net.Graphic.Core
{
    ...
    public sealed class ResultDescriptor
    {
        ...
        public ResultDescriptor(Result code, string module, string nativeApiCode, string apiCode,
        ...
        public override string ToString()
        {
            return string.Format("HRESULT: [0x{0:X}], Module: [{1}], ApiCode: [{2}/{3}], Message: {4}",
                Result.Code, Module, NativeApiCode, ApiCode, Description);
        }
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SharpDX.ResultDescriptor"/> to <see cref="int"/>.
        /// </summary>
        /// <param name="result">The result.</param>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SharpDX.ResultDescriptor"/> to <see cref="uint"/>.
        /// </summary>
        /// <param name="result">The result.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        private static string GetDescriptionFromResultCode(int resultCode)
        {
            ...
            FormatMessageW(FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS,
                IntPtr.Zero, resultCode, 0, ref buffer, 0, IntPtr.Zero);
        ...
        private static extern uint FormatMessageW(int dwFlags, IntPtr lpSource, int dwMessageId, int dwLanguageId,
